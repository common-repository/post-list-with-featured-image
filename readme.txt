...
Contributors: ddpatel4241
Donate link: https://invisiblebaba.com
Tags: post list customization, post list, post with image, post list with image, admin customization, featured image at post list
Requires at least: 3.0
Tested up to: 6.3.0
Stable tag: 1.2.0
License: Open Source Licenses
License URI: https://angelwebsolution.com
...
For Support: https://invisiblebaba.com


== Installation ==

1. Download From https://wordpress.org/plugins/post-list-with-featured-image/
...
1. On activate "Post List With Featured Image" plugin we can see image like this.
2. Setting from Admin panel.
...
= 1.0.0 =
* show featured image at post list
